<button type="button" onclick="DarkModeManager.toggle()" class="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition" aria-label="Toggle Dark Mode" title="Dark Mode Toggle">
    ...
    <svg class="w-6 h-6 text-gray-200 hidden dark:block" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
